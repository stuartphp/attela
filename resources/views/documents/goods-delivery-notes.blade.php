...
<div class="card shadow mb-4">
    <div class="card-header">
        <div class="row">
            <div class="col-md-6"><a href="{{ route('goods-delivery-notes.index') }}">{{ __('accounting_lookup.documents.goods_delivery_note') }} ({{ $data->total() }})</a></div>
            <div class="col-md-6 text-right">
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ url('/documents/goods-delivery-notes') }}" method="get">
