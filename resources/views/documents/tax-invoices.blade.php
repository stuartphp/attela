...
<div class="card shadow mb-4">
    <div class="card-header">
        <div class="row">
            <div class="col-md-10"><a href="{{ route('tax-invoices.index') }}">{{ __('documents.documents.tax_invoice') }} ({{ $data->total() }})</a></div>
            <div class="col-md-2 text-right">
                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ url('/documents/tax-invoices') }}" method="get">
