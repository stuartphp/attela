...
<div class="card shadow mb-4">
    <div class="card-header">
        <div class="row">
            <div class="col-md-6"><a href="{{ route('purchase-orders.index') }}">{{ __('accounting_lookup.documents.purchase_order') }} ({{ $data->total() }})</a></div>
            <div class="col-md-6 text-right">
                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ url('/documents/purchase-orders') }}" method="get">
...
$('#create_record').click(function () {
    ...
    $('#method').val('');
        $('#main_form').attr('action',"/documents/purchase-orders");
    $('#action').val(add);
...
$(document).on('change', '.action', function(){
    ...
    {
        case 'Edit':
            window.location.href = '/documents/purchase-orders/'+id+'/edit';
        break;
        case 'Invoice':
