...
<div class="card shadow mb-4">
    <div class="card-header">
        <div class="row">
            <div class="col-md-6"><a href="{{ route('quotations.index') }}">{{ __('documents.documents.quotation') }} ({{ $data->total() }})</a></div>
            <div class="col-md-6 text-right">
                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ url('/documents/quotations') }}" method="get">
...
$(document).on('change', '.action', function(){
    ...
    {
        case 'Edit':
            window.location.href = '/documents/quotations/'+id+'/edit';
        break;
        case 'Invoice':
