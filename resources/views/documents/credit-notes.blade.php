...
<div class="card shadow mb-4">
    <div class="card-header">
        <div class="row">
            <div class="col-md-6"><a href="{{ route('credit-notes.index') }}">{{ __('accounting_lookup.documents.credit_note') }} ({{ $data->total() }})</a></div>
            <div class="col-md-6text-end">
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ url('/documents/credit-note') }}" method="get">
          ...
          <tbody>
              @foreach ($data as $item)
                <tr>
                    ...
                    <td class="text-right pe-3 {{ ($item->total_due <0.01)? 'text-green': 'text-red' }} ">
