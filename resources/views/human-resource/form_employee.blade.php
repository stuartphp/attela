<div class="row">
    <div class="col">
        <div class="form-group row">
            ...
            <div class="col-md-8">
                <select name="type_of_certificate" id="type_of_certificate" class="form-select">
...
<div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-8">
                <select name="reason_no_uif" id="reason_no_uif" class="form-select">
                    <option value="">{{ __('global.pleaseSelect') }}</option>
            ...
            <div class="col-md-8">
                <select name="retired" id="retired" class="form-select">
            ...
            <div class="col-md-8">
                <select name="registered_medical_aid" id="registered_medical_aid" class="form-select">
                    @foreach (__('global.yesno') as $k=>$v)
                    <option value="{{ $k }}">{{ $v }}</option>
                    @endforeach
                </select>
    ...
    <div class="col"><img src="/companies/1/employees/{{ $data->image }}" height="80px" class="payslip-image"/>@if(date('m-d') == substr($data->date_of_birth, 5,5) )<img src='/images/birthday.gif' height="80px"> @endif</div>
</div>
