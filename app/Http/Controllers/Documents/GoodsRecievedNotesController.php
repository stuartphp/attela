...
class GoodsRecievedNotesController extends Controller
{
    public function index()
    {
        ...
        if(!empty($keyword))
        {
            ...
            ->where('document_type', 'goods_recieved_note')
        ...
        return view('documents.goods-recieved-notes', compact('data', 'keyword'));
