...
class GoodsDeliveryNotesController extends Controller
{
    public function index()
    {
        ...
        if(!empty($keyword))
        {
            ...
            ->where('document_type', 'goods_delivery_note')
        ...
        return view('documents.goods-delivery-notes', compact('data', 'keyword'));

    }

    public function store(){

        $document_id =(new DocumentService)->create(request('entity_id'), 'C', 'receipt', request('document_reference'));
